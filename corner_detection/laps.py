import corner_detection.utils as utils, corner_detection.debug as debug, corner_detection.deps as deps
...
__laps_model = 'corner_detection/data/models/laps.model.json'
__laps_weights = 'corner_detection/data/models/laps.weights.h5'
